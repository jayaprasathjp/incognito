            ...
            <div className="max-w-4xl mx-auto px-4 py-10 relative z-10">
                ...
                {loading ? (
                    ...
                    <div className="space-y-8">
                        ...
                        {/* Search and Filters */}
                        {!isPreGame && standardRoster.length > 0 && (
                             <div className="flex justify-between items-center mb-4">
                                <div className="relative w-full sm:w-72">
                                    ...
                                    <input 
                                        type="text" 
                                        placeholder="Search alias or school..." 
                                        value={searchQuery}
                                        onChange={(e) => setSearchQuery(e.target.value)}
                                        className="w-full pl-10 pr-4 py-3 bg-white/80 backdrop-blur-md border border-slate-200 rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-500/50 shadow-sm transition-all"
                                    />
                                </div>
                            </div>
                        )}
